...
api_key = "AIzaSyD4OiP0klcko1VV-9_TyzNa-CIX6AVy2dU"  # Set the API key in an environment variable

# Configure the Generative AI client using the API key
genai.configure(api_key=api_key)

# TensorFlow Model Prediction (Load model only once)
model = tf.keras.models.load_model("Plant_Disease_Dataset/trained_plant_disease_model.keras")
